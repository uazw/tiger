...
exports.default = (function (basePath, serverPort, configurer) {
    ...
    var server = express();
    var moduleRegistry = new ModuleRegistry_1.DefaultModuleRegistry;
    var loaderConfig = { basePath: basePath };
    var moduleLoader = ModuleLoaderFactory_1.default(StateManager_1.default, loaderConfig, moduleRegistry, server);
    if (configurer)
        configurer(server);
