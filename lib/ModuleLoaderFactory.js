...
LOGGER.level = "info";
exports.default = (function (stm, cfg, registries, server) {
    ...
    return function (module, force) {
        ...
        try {
            ...
            if (isTigerModuleDef(moduleDef))
                server[moduleDef.method](path, ExecutorFactory_1.default(path, module, stm, registries[0]));
...
function isTigerModuleDef(moduleDef) {
    return moduleDef.method !== undefined;
}
