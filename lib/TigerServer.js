...
exports.default = (function (basePath, serverPort, configurer) {
    ...
    var server = express();
    var registries = [new ModuleRegistry_1.DefaultModuleRegistry, new ModuleRegistry_1.PullModuleRegistry];
    var cfg = { basePath: basePath };
    var moduleLoader = ModuleLoaderFactory_1.default(StateManager_1.default, cfg, registries, server);
    if (configurer)
        configurer(server);
    ...
    return function () {
        fs.watch(basePath, function (evt, file) {
            ...
            if (file.match(/.*\.js$/) && fs.existsSync(fullPath)) {
                ...
                for (var _i = 0, registries_1 = registries; _i < registries_1.length; _i++) {
                    var registry = registries_1[_i];
